		...
		<>
			<header className="p-8 flex justify-between items-center border-primary text-primary">
				<div className="flex items-center">
					...
					<h1 className="ml-4 sm:ml-0 text-xl font-semibold">
						<Link to="/">
			...
			<aside
				className={`fixed top-0 left-0 h-full w-80 bg-secondary text-primary shadow-2xl z-9999 transform transition-transform duration-300 ease-in-out flex flex-col ${
